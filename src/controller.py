...
"""
    def __init__(self, Kp, setPoint):
        ...
        @param Kp is the user specified proportional gain constant
        @param setPoint is the encoder count of the desired motor location
        """
    ...
    def run(self, actualVal):
        ...
        @param actualValue is current encoder count
        """    
